import {AppConstants, ApiConstants}  from './app.constants';

function AppConfig($stateProvider, $locationProvider, $urlRouterProvider, ngMetaProvider, $provide) {
  'ngInject';
  ...
  if (AppConstants.reportingEnabled) {
    $provide.decorator('$exceptionHandler', function ($delegate, $log, $injector) {
      ...
      return function (exception, cause) {
          ...
          http.post(`${AppConstants.api}/${ApiConstants.REPORT}`, {content: data}).then(() => {
          }, (error) => {
