...
angular.module('sbAdminApp').controller('InvoicesListCtrl', ['$scope', 'RestService', 'UsersService', 'ModalService', function ($scope, RestService, UsersService, ModalService) {
    function getList() {
