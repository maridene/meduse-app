...
angular.module('sbAdminApp').controller('CreditInvoicesListCtrl', ['$scope', 'RestService', 'UsersService', 'ModalService', function ($scope, RestService, UsersService, ModalService) {
    function getList() {
