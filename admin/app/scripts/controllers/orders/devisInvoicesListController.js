...
/**
 * @ngdoc function
 * @name sbAdminApp.controller:DevisInvoicesListCtrl
 * @description
 * # MainCtrl
 * Controller of the devis invoices list page
 */

angular.module('sbAdminApp').controller('DevisInvoicesListCtrl', ['$scope', 'RestService', 'UsersService', 'ModalService', function ($scope, RestService, UsersService, ModalService) {
    function getList() {
        RestService.get('invoice/devis')
